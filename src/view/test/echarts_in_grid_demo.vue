  ...
  <div class="screen">
    ...
    <div class="grid_container">
      <div v-for="(item, i) in layout" :class="`item transparent color-${i%6}`" v-bind:key="i"
        ...
        <echartsCompontents :echart-id="item.echartId"
...
<script>
  ...
  export default {
    data() {
      return {
        layout: [
          {cols: 6, rows: 6, echartId: 'echart1'},
          {cols: 2, rows: 4, echartId: 'echart2'},
          {cols: 2, rows: 4, echartId: 'echart3'},
          {cols: 4, rows: 2, echartId: 'echart4'},
          {cols: 10, rows: 4, echartId: 'echart5'},
        ],
        echartsArray: []
      }
    },
